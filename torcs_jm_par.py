...
TARGET_SPEED = 300  # Target speed in km/h. Increasing this makes the car go faster but may reduce stability. (normal: 100)
...
GEAR_SPEEDS = [0, 10, 20, 40, 50, 90]  # Speed thresholds for gear shifting. (para volver a normal duplicar)
